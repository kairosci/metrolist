...
fun ContentSettings(
    ...
    if (showProxyConfigurationDialog) {
        ...
        var authEnabled by rememberSaveable {
                ...
                items =
                        listOf(
                                Material3SettingsItem(
                                        ...
                                        description = {
                                            Text(
                                                    LanguageCodeToName.getOrElse(contentLanguage) {
                                ...
                                Material3SettingsItem(
                                        ...
                                        description = {
                                            Text(
                                                    CountryCodeToName.getOrElse(contentCountry) {
                                                        stringResource(R.string.system_default)
                                                    }
                                            )
                                        },
                ...
                items =
                        listOf(
                                Material3SettingsItem(
                                        ...
                                        title = {
                                            Text(stringResource(R.string.show_artist_description))
                                        },
                                        trailingContent = {
                                            Switch(
                                        ...
                                        onClick = {
                                            onShowArtistDescriptionChange(!showArtistDescription)
                                        }
                                ),
                                Material3SettingsItem(
                                        ...
                                        title = {
                                            Text(
                                                    stringResource(
                                                            R.string.show_artist_subscriber_count
                                                    )
                                            )
                                        },
                                        trailingContent = {
                                            Switch(
                                                    ...
                                                    onCheckedChange =
                                                            onShowArtistSubscriberCountChange,
                                                    thumbContent = {
                                                        Icon(
                                                                painter =
                                                                        painterResource(
                                ...
                                Material3SettingsItem(
                                        ...
                                        title = {
                                            Text(
                                                    stringResource(
                                                            R.string.show_artist_monthly_listeners
                                                    )
                                            )
                                        },
                                        trailingContent = {
                                        ...
                                        onClick = {
                                            onShowMonthlyListenersChange(!showMonthlyListeners)
                                        }
                                )
                        )
        )
                        ...
                        listOf(
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                                    ...
                                    Material3SettingsItem(
                                            ...
                                            description = {
                                                Text(
                                                        LanguageCodeToName.getOrElse(appLanguage) {
                                                            stringResource(R.string.system_default)
                                                        }
                                                )
                                            },
                ...
                items =
                        listOf(
                                ...
                                Material3SettingsItem(
                                        ...
                                        onClick = {
                                            onEnableBetterLyricsChange(!enableBetterLyrics)
                                        }
                                ),
                                Material3SettingsItem(
                                        icon = painterResource(R.drawable.lyrics),
                                ...
                                Material3SettingsItem(
                                        icon = painterResource(R.drawable.language_korean_latin),
                                        title = {
                                            Text(stringResource(R.string.lyrics_romanization))
                                        },
                                        onClick = {
                                            navController.navigate("settings/content/romanization")
                                        }
                                )
                        )
        )
